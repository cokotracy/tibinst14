...
{
    'name': 'Donation Base for KYGL',
    'version': '11.0.1.0.0',
    'category': 'Accounting & Finance',
    'license': 'AGPL-3',
    'summary': 'Base module for donations for KYGL',
    'author': "Barroux Abbey, Akretion, Odoo Community Association (OCA), 0'labs",
    'website': 'https://www.olabs.be',
    'depends': ['account'],
    'data': [
